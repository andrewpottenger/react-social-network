...
const mapDispatchToProps = (
  dispatch: any,
  ownProp: IFollowingComponentProps
) => {
  return {}
}
...
const mapStateToProps = (
  ...
  ownProps: IFollowingComponentProps
) => {
  const uid = state.getIn(['authorize', 'uid'], 0)
  const circles: { [circleId: string]: Circle } = state.getIn(
    ['circle', 'circleList'],
    {}
  )
